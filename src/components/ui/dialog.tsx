...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-6 top-6 retro-button bg-gradient-to-b from-[#FF6B6B] to-[#E63946] border-[4px] border-solid border-t-[#FFB3B3] border-l-[#FFB3B3] border-r-[#B02833] border-b-[#8B1E2B] rounded-lg w-8 h-8 flex items-center justify-center text-white hover:scale-105 transition-transform">
        <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-tight mr-10",
      className
    )}
    {...props}
  />
